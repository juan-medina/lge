...
base_resource_manager::animation_library_data::~animation_library_data() {
...
auto base_resource_manager::animation_library_data::load(const std::string_view uri, resource_manager &rm) -> result<> {
