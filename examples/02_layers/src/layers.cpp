...
auto layers::create_rectangle(float pos_x, float pos_y, const glm::vec4 &color, std::mt19937 &rng) -> void {
	...
	std::uniform_real_distribution<float> size_dist_w{rect_min_width, rect_max_width};
	std::uniform_real_distribution<float> size_dist_h{rect_min_height, rect_max_height};
	std::uniform_real_distribution<float> padding_dist{rect_min_border_padding, rect_max_border_padding};
...
auto layers::create_circle(float pos_x, float pos_y, const glm::vec4 &color, std::mt19937 &rng) -> void {
	...
	std::uniform_real_distribution<float> padding_dist{rect_min_border_padding, rect_max_border_padding};
	std::uniform_real_distribution<float> radius_dist{circle_min_radius, circle_max_radius};
